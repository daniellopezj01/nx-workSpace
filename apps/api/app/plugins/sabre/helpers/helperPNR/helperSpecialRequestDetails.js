...
const helperSpecialRequestDetails = (objectFlight, activeSecurityFlight = false) => new Promise(async (resolve, reject) => {
  try {
    ...
    service.push(helperStructure('CTCM', emergency?.phone.internationalNumber.slice(1)))
