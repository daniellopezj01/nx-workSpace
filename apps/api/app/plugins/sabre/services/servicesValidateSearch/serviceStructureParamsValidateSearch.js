...
const {
  helperOriginDestination
} = require('../../helpers/HelperValidateSearch')

const serviceStructureParamsValidateSearch = (params) =>
  new Promise(async (resolve, reject) => {
    try {
      const { OTA_AirLowFareSearchRQ, schedules, segments, adults, children } =
        params
