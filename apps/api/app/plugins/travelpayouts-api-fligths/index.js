...
const {
  tap, delay, map, concatMap, retryWhen
...
const destructureParamsForUrl = (params) => new Promise((resolve) => {
  let paramUrl = ''
...
const paramsSearchAirports = (params) => new Promise((resolve, reject) => {
...
const checkParamsCheapestTickets = async (params) => new Promise((resolve, reject) => {
  const {
    origin,
    destination,
    depart_date,
...
const checkParamsNonStopTicket = async (params) => new Promise((resolve, reject) => {
  try {
    const {
      origin,
      destination,
...
const checkParamsTicketsForEachDayOfMonth = async (params) => new Promise((resolve, reject) => {
  try {
    const {
      origin,
      destination,
...
const checkParamsPopularAirlineRoute = async (params) => new Promise((resolve, reject) => {
  try {
...
const checkParamsPopularDestinations = async (params) => new Promise((resolve, reject) => {
  try {
...
const destructuringProposals = (brandData) => new Promise(async (resolve) => {
  const data = []
  await Promise.all(
...
const checkParamsFlights = (params) => new Promise((resolve, reject) => {
  try {
    const {
      passengers,
      segments,
 ...
 */
exports.cheapest_tickets = async (params) => new Promise(async (resolve, reject) => {
  try {
 ...
 */
exports.non_stop_ticket = async (params) => new Promise(async (resolve, reject) => {
  try {
 ...
 */
exports.Flight_price_trends = async (params) => new Promise(async (resolve, reject) => {
  try {
 ...
 */
exports.cheapest_tickets_Month = async (params) => new Promise(async (resolve, reject) => {
  try {
 ...
 */
exports.popular_Airline_Routes = async (params) => new Promise(async (resolve, reject) => {
  try {
 ...
 */
exports.popular_destinations = async (params) => new Promise(async (resolve, reject) => {
  try {
 ...
 * @param {*} params
 */
exports.get_flights = (params) => new Promise(async (resolve, reject) => {
  try {
 ...
 */
exports.pay_referencial = async (params) => new Promise(async (resolve, reject) => {
  try {
