...
const getContinentsAndCountries = (countriesVisited, continentsdb) =>
...
const getRouteAndCities = (itinerary) =>
  new Promise(async (resolve) => {
    let allLocations = []
...
const helperLocations = (data, continents) =>
  new Promise(async (resolve) => {
